...
export const Epsilon=(props:any)=>{
  return (
    <Link to="/">
      <Styled.Container >
      <svg width="157" height="75" id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 149.05 58.17" {...props} alt="Epsilon Logo">
  <defs>
